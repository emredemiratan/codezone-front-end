         ...
         <div className="w-full max-w-[428px] p-0">
            ...
            <form className="mt-6 w-full max-w-[416px]" onSubmit={handleEmailSubmit}>
               ...
               <div className="relative">
                  ...
                  />
                  <img
                     className="absolute top-[35px] left-0 w-full h-px object-cover"
                     alt=""
                     src="https://c.animaapp.com/wnzjM5fQ/img/vector-7.svg"
                     role="presentation"
                  />

                  <button
                     type="submit"
                     className="absolute right-0 top-0 w-[83px] h-3.5 bg-transparent cursor-pointer hover:opacity-80 transition-opacity"
                  ...
                  >
                     ...
                     <img
                        className="inline-block ml-2 w-3 h-3 align-[-2px]"
                        alt=""
                        src="https://c.animaapp.com/wnzjM5fQ/img/group-5768@2x.png"
                        role="presentation"
                     />
                  </button>
               </div>
            ...
            <nav aria-label="Footer navigation" className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-x-10 gap-y-4">
               {navigationLinks.map((link, index) => (
                  <a
                     key={index}
                     href="#"
                     className="font-saira-14-reg font-[number:var(--saira-14-reg-font-weight)] text-blackwhite text-[length:var(--saira-14-reg-font-size)] tracking-[var(--saira-14-reg-letter-spacing)] leading-[var(--saira-14-reg-line-height)] [font-style:var(--saira-14-reg-font-style)] hover:text-yellow transition-colors cursor-pointer"
                  >
                     {link.label}
                  </a>
               ))}
