    ...
    >
      <Link href="/">
        <img
          ...
          alt="Rapkology Logo"
          src="https://c.animaapp.com/kkcWJj7D/img/group-1@2x.png"
        />
      </Link>
      ...
      >
        <div className="mt-0.5 h-3.5 ml-px w-[67px] font-saira-14-bold font-[number:var(--saira-14-bold-font-weight)] text-blackblack text-[length:var(--saira-14-bold-font-size)] text-center tracking-[var(--saira-14-bold-letter-spacing)] leading-[var(--saira-14-bold-line-height)] whitespace-nowrap [font-style:var(--saira-14-bold-font-style)]">
          GİRİŞ YAP
        </div>
      </button>
      ...
      <img
        ...
        alt=""
        src="https://c.animaapp.com/kkcWJj7D/img/vector.svg"
        aria-hidden="true"
      />
    </nav>
  );
